        ...
        <div className="grid md:grid-cols-12 gap-10 mb-10">
          ...
          <div className="md:col-span-5">
            ...
            <div className="space-y-2.5">
              ...
              <a href="https://wa.me/918697974570" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-xs hover:text-white/90 transition-colors group">
                <span className="flex items-center justify-center w-7 h-7 rounded-full bg-[#25D366]/20 group-hover:bg-[#25D366]/30 transition-colors">
                  <span className="text-[#25D366]"><WhatsAppIcon /></span>
                </span>
                <span>+91 86979 74570 <span className="text-white/35">WhatsApp</span></span>
              </a>
